...
- [Roles and Personas](https://github.com/abudd1094/skills-scale-institutional-knowledge-using-copilot-spaces/blob/main/docs/octoacme-roles-and-personas.md) — Responsibilities and communication patterns for PMs, PdMs, Developers, and QA
